...
<div class="space-y-4">
	...
	<ul class="text-foreground list-disc space-y-2 pl-5">
		...
		<li>
			<strong>Analytics Cookies:</strong> These help us understand how visitors interact with our
			website through PostHog analytics. When enabled:
			<ul class="mt-2 list-disc space-y-1 pl-5">
				<li>Your visits can be tracked between page reloads and future visits on this device</li>
			...
			<p class="mt-2">
				If analytics cookies are disabled, any tracking data is cleared when you reload or leave the
				page, ensuring complete anonymity between visits.
			</p>
		</li>
	</ul>
</div>
